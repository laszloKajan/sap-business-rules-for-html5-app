		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Configured via Business Rules",
									"targetURL": "#ovhlkajanblogpostui1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ovhlkajanblogpostui1-display": {
								"semanticObject": "ovhlkajanblogpostui1",
								"action": "display",
								"description": "App Configured via Business Rules.",
								"title": "App Configured via Business Rules",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ovh.lkajan.blogpost.ui1",
									"url": sap.ui.require.toUrl("ovh/lkajan/blogpost/ui1")
								}
							}
						}
					}
